...
if __name__ == "__main__":
    ...
    def tick():
        ...
        if is_pressing("0"): b = from_text(40,50,"Type \"1\"",40,"blue", italic=False, bold=False)
        elif is_pressing("1") : b = from_text(40,50,"Type \"2\"",40,"green", italic=True, bold=True)
        elif is_pressing("2") : b = from_text(40,50,"Type \"3\"",40,"white", italic=False, bold=True)
        elif is_pressing("a") : stop_loop()
